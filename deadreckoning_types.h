...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_deadreckoning_sensor_msgs_LaserScan_
#define DEFINED_TYPEDEF_FOR_SL_Bus_deadreckoning_sensor_msgs_LaserScan_
...
typedef struct {
  ...
  // MsgType=std_msgs/Header
  SL_Bus_deadreckoning_std_msgs_Header Header;
} SL_Bus_deadreckoning_sensor_msgs_LaserScan;
